...
int Evaluation::evaluate(char b[N][N])
{
	...
	for (int row = 0; row<N; row++)
	{
		for(int j = 0; j<N; j++)
		{
			...
			{
				if (b[row][j]==Evaluation::player)
					return +10;
				else if (b[row][j]==Evaluation::opponent)
					return -10;
			}
		}
	}
	...
	for (int col = 0; col<N; col++)
	{
		for(int i = 0; i<N; i++)
		{
			...
			{
				if (b[i][col]==Evaluation::player)
					return +10;

				else if (b[i][col]==Evaluation::opponent)
					return -10;
			}
		}
	}
	...
	for(int i = 0; i<N;i++)
	{
		for(int j = 0; j<N;j++)
		{
			if (i==j)
			{
				...
				{
					if (b[i][j]==Evaluation::player)
						return +10;
					else if (b[i][j]==Evaluation::opponent)
						return -10;
				}
			}
		}
	...
	for(int i = 0; i<N;i++)
	{
		for(int j = 0; j<N;j++)
		{
			if (i==N-j-1)
			{
				...
				{
					if (b[i][N-j-1]==Evaluation::player)
						return +10;
					else if (b[i][N-j-1]==Evaluation::opponent)
						return -10;
				}
			}
		}
